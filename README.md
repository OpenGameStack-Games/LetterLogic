...
- **1930s Mascot & Monochrome Visual Aesthetic:** Launches with a custom boot splash screen featuring our signature 1930s walking cartoon tile mascot over a matching dark monochrome background (`#121212`), completely free of engine branding or text. On the main menu, an expressive rubber-hose mascot plays a subtle rocking sway idle animation! High-contrast charcoal buttons, rounded white borders, and sleek panels embrace a vintage black-and-white art style, reserving chromatic color strictly for gameplay evaluation cues so deduction pops with maximum impact.
